...
<body class="main-body leftmenu ltr dark-theme">
					...
					<div class="row row-sm">
								...
								<div class="row row-sm">
									<div class="card-body mt-2 mb-2">
										<div class="mobilelogo">
											<img src="logo.png" class=" d-lg-none header-brand-img text-start float-start mb-4 dark-logo" style="width: 150px;height: 80px;" alt="logo">
											<img src="logo.png" class=" d-lg-none header-brand-img text-start float-start mb-4 light-logo" style="width: 150px;height: 80px;" alt="logo">
										</div>
						...
						<div class="col-lg-6 col-xl-6 d-none d-lg-block text-center bg-primary details rounded-end-11">
							<div class="mt-4 pt-4 p-2 pos-relative">
								<a href="index.html">
									<img src="logo.png" class="header-brand-img mb-3 mt-3" style="width: 150px;height: 80px;" alt="logo">
								</a>
	...
	<!-- chatWay LiveChat -->
	<script id="chatway" async="true" src="https://cdn.chatway.app/widget.js?id=Sol6cbvhvznm"></script>
	<!-- Jquery js-->
