		...
		<div class="main-header side-header sticky">
			<div class="main-container container-fluid">
				<div class="main-header-left">
					...
					<div class="hor-logo">
						<a class="main-logo border border-danger" href="index.php">
							<img src="../logo.png" class="header-brand-img desktop-logo img-fluid" style="width: 100px;height: 80px;" alt="logo">
							<img src="../logo.png" class="header-brand-img desktop-logo-dark img-fluid" style="width: 100px ;height: 80px;" alt="logo">
						</a>
					</div>
				</div>
				<div class="main-header-center">
					<div class="responsive-logo">
						<a href="index.php"><img src="../logo.png" class="mobile-logo" style="width: 100px;height: 50px;" alt alt="logo" width="150px"></a>
						<a href="index.php"><img src="../logo.png" class="mobile-logo-dark" style="width: 100px;height: 50px;" alt alt="logo" width="150px"></a>
					</div>
				</div>
				...
				<div class="main-sidebar-header main-container-1 active">
					<div class="sidemenu-logo">
						<a class="main-logo" href="index.php">
							<img src="../logo.png" class="header-brand-img desktop-logo-dark" width="50px" height="50px" alt="logo">
							<img src="../logo.png" class="header-brand-img icon-logo-dark" alt="logo">
							<img src="../logo.png" class="header-brand-img desktop-logo" alt="logo" width="50px" height="50px">
							<img src="../logo.png" class="header-brand-img icon-logo" alt="logo">
						</a>
					</div>
